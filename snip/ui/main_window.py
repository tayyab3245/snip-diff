...
from snip.ui.file_tree   import FileTree
from snip.ui.enhanced_preview_panel import EnhancedPreviewPanel
from snip.ui.toolbar_neumorphic import NipToolBar
from snip.ui.status_overlay import StatusOverlay, StatusManager
from snip.core.worker      import DiffWorker
from snip.core.fast_diff_worker import FastDiffWorker
from snip.config           import theme_manager
...
class MainWindow(QMainWindow):
    ...
    def _on_folder_selected(self, folder_path: str):
        ...
        from snip.core.cached_diff_engine import cached_diff_engine
    ...
    def _start_fast_diff(self, is_user_action: bool = True) -> None:
        ...
        if self._watcher is None and self.toolbar.btn_live._button.isChecked():
            from snip.core.worker import LiveWatcher
